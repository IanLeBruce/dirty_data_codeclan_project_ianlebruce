...
* The clean data should be in tidy format as covered in week 2.
* Follow the style guide covered in week 1 for both code style, and naming data and variables. 
* Look over the reproducibility lesson from week 2 again to help you think about how to organise your project. Following the steps there to ensure reproducibility and clarity for review, and recap the hints and tips for writing documentation. 
...
The MVP for the project will be:

* completing the cleaning, analysis and full documentation for Task 4.
* creating visualisations to convey some insight of the data.

On Friday each group will give a short presentation (up to 10 minutes) that will discuss one of the Tasks. The presentation should include:

- a brief introduction to the data.
- a discussion of cleaning steps
- visualisations that explore the data.
- key findings from the analysis

It's not required for MVP but it's always nice to include:

- difficulties faced
- how the group worked in a team (tools used, how tasks were broken down)
- things learned along the way

Everyone in the group will need to push the complete cleaning and analysis files to their project repo **by 10am on Friday**. 

Each group will need to submit their presentation slides


## Extension

If you finish the MVP, you are welcome to complete any of the other tasks. Or you can do the extension tasks 5 and 6 which have been provided. If you do any extra tasks, please remember to complete all documentation as well!

Another idea would be taking your clean data and using it to create a dashboard using tableau.
