...
- 100m Time by competitor by competition
...
- Geolocation of the penguins (look into the `{maps}` package)
- Histogram of observation counts. How many birds seen in groups of 1, 2, 3, ... etc.?
...
- Proportion of missing values (per year / per gender / per country)
